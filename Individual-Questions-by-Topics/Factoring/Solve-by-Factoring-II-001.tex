...
\pgfmathtruncatemacro{\b}{random(1,5)}
 ...
 \pgfmathsetmacro{\D}{int(random(1,7))}
\pgfmathsetmacro{\CD}{int(\C-\D)}


Solve the following equation by factoring 
\[\invisibleoneincoef{\A} \varx^2  \plusminus{\B}\varx \ifnum\CD>0 +\CD\else \CD\fi=-\D.\]
...
\[
  \begin{split}
    \invisibleoneincoef{\A} \varx^2  \plusminus{\B}\varx \ifnum\CD>0 +\CD\else \CD\fi&=-\D\\
  \invisibleoneincoef{\A}\varx^2  \plusminus{\B}\varx \ifnum\C>0 +\C\else \C\fi&=0\\
  (\invisibleoneincoef{\a}\varx-\b)(\invisibleoneincoef{\c}\varx-\d)&=0.
  \end{split}
\]
\begin{alignat*}{3}
  \invisibleoneincoef{\a}\varx-\b&=0 && \ctc{or} & \invisibleoneincoef{\c}\varx-\d &=0\\
    x&=\reducedfraction{\b}{\a} && \ctc{or} & x &=\reducedfraction{\d}{\c}
\end{alignat*}
\columnbreak

\begin{center}
  Factor $\invisibleoneincoef{\A}\varx^2  \plusminus{\B}\varx \ifnum\C>0 +\C\else \C\fi$.
